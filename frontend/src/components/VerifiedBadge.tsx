...
/** User verification badge (admin-verified account). Cyan star+check. */
...
/**
 * Green verified badge for commits / releases (GitHub-style “Verified”).
 */
export function VerifiedCommitBadge({
  className,
  size = 14,
  label = 'Verified',
}: {
  ...
  const title =
    'Verified — this commit was authored by a SoftGit account verified by site administration.'
  return (
    <span
      className={cn(
        'inline-flex items-center gap-0.5 align-middle text-[11px] font-medium shrink-0',
        className
      )}
      style={{ color: '#669d34' }}
      title={title}
...
/** Display name + optional user verified badge. */
